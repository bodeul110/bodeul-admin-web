...
계약 대조: 2026-09-21. 아래 9월 5~6일 결과는 당시 검증 이력이며 이번 문서 수정에서 재실행하지 않았다.
...
1. 메인 PR #406과 웹 PR #51은 병합됐고 개발 DB V23 실연동 검증 기록이 있다. 새 환경에서는 해당 환경의 V23 실제 적용부터 확인한다. 웹 저장소에서 DDL이나 DB 권한을 직접 변경하지 않는다.
